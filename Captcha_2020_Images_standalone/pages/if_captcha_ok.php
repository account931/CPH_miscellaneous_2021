...
if(!isset($_SESSION["CaptchaOK"]) && $_SESSION["CaptchaOK"] != true){
...
<!--------------------------------Bootstrap  Main variant ------------------------------------------>
  <html lang="en-US">
    ...
    <body>
        ...
        <div id="headX" class="jumbotron text-center gradient head-style" style ='background:lime;'> <!--#2ba6cb;-->
            <h1 id="h1Text"> <span id="textChange"> Captcha OK</span>   </h1>
            <p class="header_p"> 
			    You solved captcha correctly </p> 
			    <p><i class="fa fa-gift" style="font-size:106px"></i></p> 
                <!--<p class="language"><a href="../">Ru</a></p>-->
				<p><button class="btn btn-success"> <a style="color:white; font-size:0.6em;" href="../"> go to main page </a></button> </p>
	    </div>
